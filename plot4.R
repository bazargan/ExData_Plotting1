...
# Openning a png graphic device with the specified dimensions, and setting 
# the template for a 4 graph grid
png(filename = "plot4.png", width = 480, height = 480, units = "px")
par(mfrow = c(2,2))

# plotting the graphs on the grid
plot(sub_data$DateTime, sub_data$Global_active_power, type = "l", xlab = "", 
        ylab = "Global Active Power")
plot(sub_data$DateTime, sub_data$Voltage, type = "l", xlab = "datetime", 
        ylab = "Voltage")
